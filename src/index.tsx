...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .hero-cta:hover { background: #05b34c; box-shadow: 0 8px 28px rgba(6,199,85,.4); }
    .hero-cta-note {
      font-family: 'Noto Sans JP', sans-serif;
...
<section id="hero">
  ...
  <div class="hero-content">
    ...
    <div class="hero-cta-row r d4 on">
      <a href="https://s.lmes.jp/landing-qr/2009477605-NXOfJLH0?uLand=n4pPW4" target="_blank" rel="noopener" class="hero-cta">
...
app.get('/robots.txt', (c) => {
  return c.text(`User-agent: *\nAllow: /\nSitemap: https://clover-fit.com/sitemap.xml`)
})
